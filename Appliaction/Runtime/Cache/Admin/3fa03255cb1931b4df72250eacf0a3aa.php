                                            ...
                                            <div class="widget-header">
                                                    <div class="widget-toolbar no-border">
                                                            <ul class="nav nav-tabs" id="myTab">
                                                                    <li class="active"><a data-toggle="tab" href="#home1">分类管理</a></li>
                                                                                            ...
                                                                                            <div class="table-responsive">
                                                                                                    <table id="sample-table-1"
                                                                                                            ...
                                                                                                            <?php if(is_array($menu)): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                                                                                                                            ...
                                                                                                                            <td parent="<?php echo ($menu["tb_pid"]); ?>"><?php echo ($menu["tb_mid"]); ?></td>
                                                                                                                            <td class="hidden-480"><?php echo ($menu["tb_name"]); ?></td>

                                                                                                                            <td><a href="javascript:void(0);" onclick="addSubmenu(this)" class="addsub btn btn-white btn-sm">添加子类</a><a href="javascript:void(0);" onclick="reSubmenu(this)" class="btn btn-white btn-sm">修改</a><a class="J_ajax_del btn btn-white btn-sm" href="<?php echo U('Admin/Menu/del',array('id'=>$menu['tb_mid']));?>">删除</a></td>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                    ...
                                                                                                                                    <td>
                                                                                                                                            <select name="parent" class="normal_select">
                                                                                                                                                    ...
                                                                                                                                                    <?php if(is_array($menulist)): $i = 0; $__LIST__ = $menulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menulist): $mod = ($i % 2 );++$i;?><option value="<?php echo ($menulist["tb_mid"]); ?>"><?php echo ($menulist["tb_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>  
                                                                                                                                            </select>
                                                                                                                                    </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
