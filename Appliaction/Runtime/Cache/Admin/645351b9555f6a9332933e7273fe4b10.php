...
<div class="main-container" id="main-container">
	...
	<ul class="nav nav-list">
			...
			<a href="javascript:void(0)">
                            <i class="icon-home"></i>
                            <span class="menu-text"> 商城设置 </span></a>
		</li>
		<li>
			<a href="javascript:void(0)">
                            <i class="icon-list"></i>
                            <span class="menu-text"> 菜单管理 </span></a>
		</li>
               <li>
			<a href="javascript:void(0)" >
                            <i class="icon-group"></i>
                            <span class="menu-text"> 分销商管理 </span></a>
		</li>
                <li>
			<a href="javascript:void(0)" >
                            <i class="icon-group"></i>
                            <span class="menu-text"> 用户管理 </span></a>
		</li>
                
                <li>
			<a href="javascript:void(0)" >
                            <i class="icon-group"></i>
                            <span class="menu-text"> 商品分成管理 </span></a>
		</li>
	...
	<script type="text/javascript">
		...
		<script type="text/javascript">
			...
			$(this).addClass('active');
                        $('#breadcrumbs ul li').eq(0).html('商城设置'); 
		...
		$('.nav.nav-list li').eq(1).click(function() {
			...
			//$(window.location.href="<?php echo U('Admin/Menu/index');?>");
		...
		$('.nav.nav-list li').eq(2).click(function() {
			...
			$('.nav.nav-list li').removeClass('active');
			$(this).addClass('active');
                        $('#breadcrumbs ul li').eq(1).html('商品分成管理');
                       // $(window.location.href="<?php echo U('Admin/User/index');?>");
			
			$('#main_iframe').attr("src","<?php echo U('Admin/Goods/index');?>");
		});
