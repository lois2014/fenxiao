			...
			<div class="widget-main padding-12 no-padding-left no-padding-right">
				<div class="tab-content padding-4">
					<div id="home1" class="tab-pane in active">
						<div class="row">
							<div class="col-xs-12 no-padding-right">
								<form class="form-horizontal" role="form" action="<?php echo U('Admin/Index/set');?>" method="post">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1"
												value="<?php echo ($result["tb_stheme"]); ?>" name="theme" class="col-xs-10 col-sm-6">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"
												value="<?php echo ($result["tb_sannounce"]); ?>" name="announce" class="col-xs-10 col-sm-6">
										</div>
									</div>
					...
					<div id="home5" class="tab-pane in">
						<div class="row">
							<div class="col-xs-12 no-padding-right">
                                                            <form class="form-horizontal" role="form" action="<?php echo U('Admin/Index/password_modify');?>" method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"
										...
										<div class="col-sm-9">
											<input type="password" id="form-field-1"
												value="" name="oldpwd" class="col-xs-10 col-sm-6">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="form-field-2"
												value="" name="newpwd" class="col-xs-10 col-sm-6">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="form-field-2"
												value="" name="newrepwd" class="col-xs-10 col-sm-6">
										</div>
									</div>
							...
							<div class="col-xs-12 no-padding-right">
								<form class="form-horizontal" role="form" action="<?php echo U('Admin/Index/addadmin');?>" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="form-field-2"
												value="" name="pwd" class="col-xs-10 col-sm-6">
										</div>
									</div>
							...
							<div class="col-xs-12 no-padding-right">
								<div class="table-responsive">
									<table id="sample-table-1"
										...
										<tbody>
										<?php if(is_array($resulta)): $i = 0; $__LIST__ = $resulta;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$resulta): $mod = ($i % 2 );++$i;?><tr>
												<td class="center"><label> <input
														type="checkbox" class="ace"> <span class="lbl"></span>
												</label></td>

												<td><?php echo ($resulta["tb_aid"]); ?></td>
												<td><?php echo ($resulta["tb_username"]); ?></td>
												
												<td><a class="J_ajax_del btn btn-white btn-sm" href="javascript:drop_confirm('删除后不能再恢复 确定删除吗？','<?php echo U('Admin/Index/deladmin',array('id'=>$resulta['tb_aid']));?>')">删除</a>
                                                                                                    <script>
														function drop_confirm(message,pathurl)
														{
															...
															{
                                                                                                                            window.location.href=U('Admin/Index/set');
																//return false;
															}
														}
													</script>
