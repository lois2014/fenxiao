...
<div> 
    ...
    <form method="post" action="<?php echo U('Admin/User/modify',array('id'=>$_GET['id']));?>">
        ...
        <div>
            ...
            <li>等级：<input type="text" class="" name="level" value="<?php echo ($result['tb_level']); ?>">(1-分销商，0-用户)</li>
            <li><input type="submit" value="修改">  <a href="<?php echo U('Admin/User/index',array('id'=>$_GET['id']));?>">返回</a></li>  
